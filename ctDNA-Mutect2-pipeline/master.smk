...
configfile: "/work/sduvarcall/G35-2016-Genova/samples-perType.yaml"
...
# PLASMAS = [config[sample]["plasma"] for sample in config] + ["G35-P4-PLASMA_thruplex-tag-seq-hv_HVFFCDSXY"]
# print(SAMPLES)
# print(PLASMAS)
