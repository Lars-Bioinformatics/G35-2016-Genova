...
rule vcf_merge_singleSample:
    ...
    output:
        merged_vcf=main_output+"union_vcf/{sample}_mutect2_matched_filterFlag_norm_PASSonly_merged.vcf.gz"
    shell:
        """
        cp {input.norm_vcfs_matched} {output.merged_vcf}
...
#     shell:
#         """
#         bcftools merge -Oz -m none --force-samples {input.norm_vcfs_matched} > {output.merged_vcf}
#         bcftools index -t {output.merged_vcf}
#         """
