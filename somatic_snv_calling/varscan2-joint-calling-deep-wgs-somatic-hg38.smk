...
####                      Output                     ####
#########################################################
output_somatic = "varscan_somatic_joint_calling_default/"
...
rule all_pairs:
    input:
        ...
        expand(output_somatic+"{sample}_cns_varscan2_somatic_1000g-pon_gnomadAF_above0_001-filtered.vcf.gz", sample=PATIENTS),
...
rule gnomad_filtering_0_001:
    ...
    output:
        vcf = output_somatic+"{sample}_cns_varscan2_somatic_1000g-pon_gnomadAF_above0_001-filtered.vcf.gz",
    shell:
        """
        bcftools isec \
        -C \
