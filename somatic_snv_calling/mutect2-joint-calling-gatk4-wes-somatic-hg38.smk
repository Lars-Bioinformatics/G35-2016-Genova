...
####                      Output                     ####
#########################################################
log_file = "log_mutect2_joint_calling_try3.txt"
output_somatic = "mutect2_joint_calling_try3/"
...
rule Mutect2_matched:
    ...
    resources: cpus=4, mem=24000
    shell:
        """
        gatk --java-options -Xmx{resources.mem}g Mutect2 \
        -R {ref} \
        {params.tumors} \
        -I {input.normal} \
        {params.normal_name} \
